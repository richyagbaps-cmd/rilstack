    ...
    <>
      <div className="w-full max-w-2xl mx-auto mb-10">
        <div className="flex rounded-2xl bg-[#f3f4fa] p-2 shadow gap-3 md:gap-6">
          <button className={`flex-1 py-4 md:py-5 rounded-xl font-semibold text-base md:text-lg ${tab === 0 ? 'text-[#2c3e5f] bg-white shadow' : 'text-[#4A5B6E]'} transition`} onClick={() => setTab(0)}>Overview</button>
          <button className={`flex-1 py-4 md:py-5 rounded-xl font-semibold text-base md:text-lg ${tab === 1 ? 'text-[#2c3e5f] bg-white shadow' : 'text-[#4A5B6E]'} transition`} onClick={() => setTab(1)}>Budget & Save</button>
          <button className={`flex-1 py-4 md:py-5 rounded-xl font-semibold text-base md:text-lg ${tab === 2 ? 'text-[#FFD700] bg-white shadow' : 'text-[#FFD700] hover:text-[#2c3e5f]'}`} onClick={() => setTab(2)}>Invest</button>
        </div>
      </div>
      {tab === 0 && (
        <>

      ...
      >
        ...
        >
          <h1
            style={{
              fontSize: "4.5rem",
              fontWeight: 800,
              background: "linear-gradient(135deg, #fff, #a0e0ff, #3e8eff)",
              WebkitBackgroundClip: "text",
              backgroundClip: "text",
              color: "transparent",
              marginBottom: "1rem",
          ...
          >
            <button
              ...
              style={{
                background: "linear-gradient(105deg, #2b6ef0, #1645b0)",
                border: "none",
                padding: "0.9rem 2rem",
                borderRadius: 60,
                fontWeight: 700,
        ...
        <div
          ...
          style={{
            ...
            padding: "4rem 2rem",
            background:
              "linear-gradient(180deg, rgba(5,15,30,0.7), rgba(1,5,15,0.9))",

...
export default function RelaxedBudgetTypePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#f8f9fc] p-8">
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full flex flex-col items-center">
        <h1 className="text-2xl font-bold mb-6 text-[#FFD700]">Choose Budget Type</h1>
        <p className="mb-8 text-[#4A5B6E] text-center">Select a budgeting method that fits your style:</p>
        <div className="flex flex-col gap-6 w-full">
          <button
            className="w-full bg-[#7C3AED] text-white font-bold py-3 rounded-lg shadow hover:bg-[#5B21B6] transition text-lg"
            onClick={() => router.push("/budgets/budget/relaxed/502030")}
          ...
          <button
            ...
            onClick={() => router.push("/budgets/budget/relaxed/zero-based")}
          ...
          <button
            ...
            onClick={() => router.push("/budgets/budget/relaxed/custom")}

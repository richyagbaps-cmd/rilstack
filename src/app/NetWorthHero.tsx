    ...
    <>
      <div className="w-full max-w-2xl mx-auto bg-white/90 rounded-3xl shadow-2xl p-6 sm:p-10 mt-4 sm:mt-8 mb-8 flex flex-col items-center relative">
        <div className="absolute top-4 right-4 flex gap-2">
          <button
            className="bg-[#00e096] text-white px-4 py-2 rounded-lg font-semibold shadow hover:bg-[#00c080] transition"
            onClick={handleAddMoney}
          >
            Add Money
          </button>
          <button
            className="bg-[#2c3e5f] text-white px-4 py-2 rounded-lg font-semibold shadow hover:bg-[#1a2253] transition"
            onClick={handleCreateBudget}
          >
            Create Budget
          </button>
          <button
            className="bg-[#FFD700] text-[#2c3e5f] px-4 py-2 rounded-lg font-semibold shadow hover:bg-[#ffe066] transition"

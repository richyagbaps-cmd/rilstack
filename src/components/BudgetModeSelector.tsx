...
export default function BudgetModeSelector({
  onModeSelect,
}: BudgetModeSelectorProps) {
  const [selectedMode, setSelectedMode] = useState<"strict" | "relaxed" | null>(
    null,
  );
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FC] p-4 md:p-8">
      ...
      <div className="mx-auto mb-10 max-w-6xl md:mb-16">
        <h1 className="mb-4 text-3xl font-bold text-[#1E2A3A] md:text-5xl">
          Choose Your Budgeting Style
        </h1>
        <p className="text-base text-[#4A5B6E] md:text-lg">
          Select how you want to manage your finances. You can change this
          anytime.
        </p>
      </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-emerald-100 leading-relaxed">
                  Your money is locked in designated accounts based on how often
                  you need it. Once locked, funds can only be released on the
              ...
              <div>
                ...
                <ul className="space-y-2 text-emerald-100">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <strong>Daily:</strong> Money unlocks each day for
                      recurring expenses
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-emerald-300 font-semibold">•</span>
                    <span>
                      <strong>Weekly:</strong> Money unlocks each week
                      (groceries, transport)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-emerald-300 font-semibold">•</span>
                    <span>
                      <strong>Monthly:</strong> Money unlocks monthly (rent,
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-emerald-300 font-semibold">•</span>
                    <span>
                      <strong>Yearly:</strong> Money unlocks yearly (insurance,
                      annual fees)
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-emerald-900/30 rounded-lg p-4 border border-emerald-500/50">
                <p className="text-emerald-100 text-sm">
                  <strong>Zero Penalty:</strong> No penalty for emergency early
          ...
          <div className="relative p-6 text-white md:p-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-emerald-100 leading-relaxed">
                  Full flexibility with your budget. Withdraw money from any
                  category anytime you need it. A small penalty applies to
              ...
              <div className="bg-red-900/30 rounded-lg p-4 border border-red-500/50">
                <p className="text-red-100 text-sm">
                  <strong>2% Withdrawal Penalty:</strong> Each withdrawal incurs
                  a 2% fee on the amount withdrawn
                </p>
              </div>
            </div>
      ...
      <div className="mx-auto mb-10 max-w-6xl md:mb-12">
        <h2 className="mb-6 text-2xl font-bold text-[#1E2A3A] md:mb-8 md:text-3xl">
          Quick Comparison
        </h2>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-[#F1F4F9] border-b border-[#E9EDF2]">
                <th className="px-4 py-4 text-left text-sm font-semibold text-[#1E2A3A] md:px-6">
                  Feature
                </th>
                <th className="px-4 py-4 text-center text-sm font-semibold text-[#2c3e5f] md:px-6">
                  STRICT MODE
                </th>
                <th className="px-4 py-4 text-center text-sm font-semibold text-[#4A8B6E] md:px-6">
                  RELAXED MODE
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#E9EDF2]">
              <tr className="hover:bg-[#F8F9FC] transition-colors">
                <td className="px-4 py-4 text-sm text-[#4A5B6E] md:px-6">
                  Withdrawal Freedom
                </td>
                <td className="px-4 py-4 text-center text-sm text-[#2c3e5f] md:px-6">
                  Limited (by unlock date)
                </td>
                <td className="px-4 py-4 text-center text-sm text-[#4A8B6E] md:px-6">
                  Unlimited
                </td>
              </tr>
              <tr className="hover:bg-[#F8F9FC] transition-colors">
                ...
                <td className="px-4 py-4 text-center text-sm text-red-500 md:px-6">
                  2% on amount
                </td>
              </tr>
              <tr className="hover:bg-[#F8F9FC] transition-colors">
        ...
        <div className="rounded-[28px] border border-[#E9EDF2] bg-white p-6 shadow-sm md:p-8">
          ...
          <ul className="space-y-3 text-[#4A5B6E]">
            <li className="flex gap-3">
              ...
              <span>
                <strong>Use STRICT</strong> for essential, recurring expenses
            ...
            <li className="flex gap-3">
              <span className="text-[#2c3e5f]">→</span>
              <span>
                <strong>Use RELAXED</strong> for variable expenses like dining,
            ...
            <li className="flex gap-3">
              <span className="text-[#2c3e5f]">→</span>
              <span>
                <strong>Hybrid Approach:</strong> Many users combine both modes
                - strict for essentials, relaxed for discretionary
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-[#2c3e5f]">→</span>
              <span>
                <strong>Easy Switch:</strong> Change modes anytime from your
                dashboard settings
              </span>
            </li>
          </ul>

...
export default function ThreeDHome() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const helixRing = new THREE.Mesh(
        new THREE.TorusGeometry(0.95, 0.05, 48, 160),
      ...
      for (let i = 0; i < orbCount; i++) {
        ...
        const cubeMat = new THREE.MeshStandardMaterial({
          color: [0x4cd964, 0xffb347, 0x3e8eff][Math.floor(Math.random() * 3)],
      ...
      const starMatBG = new THREE.PointsMaterial({
        color: 0xffffff,
        size: 0.08,
        transparent: true,
        opacity: 0.6,

    ...
    <>
          ...
          <div className="relative">
            ...
            >
              {user?.image ? (
                ...
                <FaUserCircle size={24} color="#1A5F7A" />
              )}
            </button>
            {profileOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white border border-[#E9EDF2] rounded-lg shadow-xl z-50 py-2">
                <button
      ...
      {drawerOpen && (
        <div className="fixed inset-0 z-50 flex" role="dialog" aria-modal="true">
          <div className="w-72 bg-white h-full shadow-2xl flex flex-col p-0 gap-0 border-r border-[#E9EDF2] animate-slideInLeft overflow-y-auto">
            {/* Drawer Header */}
            ...
            <div className="p-6 pb-0">
              ...
              <div className="flex flex-col gap-1 mb-6">
                ...
                <button className="flex items-center gap-3 text-left py-2 px-2 rounded hover:bg-[#F8F9FA] text-[#F4A261] font-semibold focus:outline-none focus-visible:ring-2 focus-visible:ring-[#F4A261]" tabIndex={0} onClick={() => { setDrawerOpen(false); alert('Forgot Password flow coming soon!'); }}>
                  <span role="img" aria-label="Forgot Password" className="text-xl"></span> Report Fraud
                </button>
              </div>
              ...
              <div className="flex flex-col gap-1 mb-6">
                ...
                <button className="flex items-center gap-3 text-left py-2 px-2 rounded hover:bg-[#F8F9FA] text-[#D32F2F] font-semibold focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D32F2F]" tabIndex={0} onClick={() => { setDrawerOpen(false); alert('Delete Account flow coming soon!'); }}>
                  <span role="img" aria-label="Delete Account" className="text-xl"></span> Delete Account
                </button>
              </div>
              ...
              <div className="flex flex-col gap-1 mb-6">
                ...
                <button className="flex items-center gap-3 text-left py-2 px-2 rounded hover:bg-[#F8F9FA] text-[#1A5F7A] font-semibold focus:outline-none focus-visible:ring-2 focus-visible:ring-[#1A5F7A]" tabIndex={0} onClick={() => { setDrawerOpen(false); alert('Privacy mode toggle coming soon!'); }}>
                  <span role="img" aria-label="Privacy Mode" className="text-xl"></span> Privacy Mode
                </button>
              ...
              <div className="flex flex-col gap-1 mb-6">
                <div className="flex items-center gap-3 py-2 px-2 text-[#4A5B6E] font-semibold select-none">
                  <span role="img" aria-label="Version" className="text-xl">?</span> rilstack v1.0.0
                </div>
                <button
                  className="flex items-center gap-3 text-left py-2 px-2 rounded hover:bg-[#F8F9FA] text-[#F4A261] font-semibold focus:outline-none focus-visible:ring-2 focus-visible:ring-[#F4A261]"
                  tabIndex={0}
                  onClick={() => {
                    setDrawerOpen(false);
                    alert("Rate the app coming soon!");
                  }}
                >
              ...
              <div className="mt-auto border-t border-[#E9EDF2] p-4">
                <button
                  className="w-full flex items-center gap-3 justify-center text-left py-3 px-2 rounded text-[#D32F2F] font-bold hover:bg-[#F8F9FA] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D32F2F]"
                  tabIndex={0}
                  onClick={() => {
                    setDrawerOpen(false);
                    signOut({ callbackUrl: " / "});

...
export default function UserProfile({ onClose }: UserProfileProps) {
  ...
  const { register, handleSubmit, reset } = useForm<Omit<UserProfileData, 'id'>>();
        ...
        <div className="p-6">
          {!isEditing && userProfile ? (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="rounded-lg bg-gray-50 p-4">
                  ...
                  <p className="break-all text-lg font-semibold">{userProfile.email}</p>
                </div>
                ...
                <div className="rounded-lg bg-gray-50 p-4 md:col-span-2">
                  <p className="mb-1 text-sm text-gray-600">NIN (National Identification Number)</p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                <label className="mb-2 block text-sm font-semibold">NIN (National Identification Number)</label>
                <input
                  type="text"
                ...
                />
                <p className="mt-1 text-xs text-gray-500">11-digit number from your national ID</p>
              </div>

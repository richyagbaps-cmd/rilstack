...
const BUDGET_STYLE_INFO: Array<{
...
}> = [
  {
    ...
    description:
      "A balanced split for essentials, lifestyle spending, and savings.",
    explanation:
      "50% goes to needs, 30% to wants, and 20% to savings or future goals.",
  },
  {
    id: "zero-based",
    ...
    explanation:
      "Your full income is distributed across expense and savings categories until nothing is left unplanned.",
  },
  {
    id: "custom",
    title: "Custom Budget",
    description:
      "Start from a smart draft, then shape the plan around your own priorities.",
    explanation:
      "Good if you want more freedom while still using profession-based category suggestions.",
  },
];
  ...
  student: [
    {
      ...
      note: "Meals, groceries, and cooking supplies.",
      cadence: "daily",
    },
    {
      name: "Transport",
      group: "Essential Expenses",
      note: "Daily commuting and occasional travel.",
      cadence: "daily",
    },
    {
      name: "School Fees",
      group: "Essential Expenses",
      note: "Tuition, registration, and academic costs.",
      cadence: "monthly",
    },
    {
      name: "Data & Airtime",
      group: "Flexible Expenses",
      note: "Connectivity for classes and communication.",
      cadence: "weekly",
    },
    {
      name: "Personal Care",
      group: "Flexible Expenses",
      note: "Toiletries, laundry, and small personal needs.",
      cadence: "weekly",
    },
    {
      name: "Books & Learning",
      group: "Savings & Goals",
      note: "Courses, books, projects, and study tools.",
      cadence: "monthly",
    },
    {
      name: "Emergency Buffer",
      group: "Savings & Goals",
      note: "Small reserve for urgent student needs.",
      cadence: "monthly",
    },
  ],
  worker: [
    {
      name: "Food & Groceries",
      group: "Essential Expenses",
      note: "Monthly food and home supplies.",
      cadence: "daily",
    },
    {
      name: "Transport",
      group: "Essential Expenses",
      note: "Commuting, fuel, or ride-hailing costs.",
      cadence: "daily",
    },
    {
      name: "Rent & Housing",
      group: "Essential Expenses",
      note: "Rent, service charge, and housing upkeep.",
      cadence: "monthly",
    },
    {
      name: "Utilities",
      group: "Essential Expenses",
      note: "Power, water, internet, and subscriptions.",
      cadence: "monthly",
    },
    {
      name: "Dining & Lifestyle",
      group: "Flexible Expenses",
      note: "Restaurants, outings, and entertainment.",
      cadence: "weekly",
    },
    {
      name: "Family Support",
      group: "Flexible Expenses",
      note: "Support for family or dependants.",
      cadence: "weekly",
    },
    {
      name: "Emergency Savings",
      group: "Savings & Goals",
      note: "Cash reserve for unexpected costs.",
      cadence: "monthly",
    },
    {
      name: "Investments",
      group: "Savings & Goals",
      note: "Long-term growth and future planning.",
      cadence: "monthly",
    },
  ],
  entrepreneur: [
    {
      name: "Home Expenses",
      group: "Essential Expenses",
      note: "Personal housing and household costs.",
      cadence: "daily",
    },
    {
      name: "Business Operations",
      group: "Essential Expenses",
      note: "Inventory, logistics, tools, and recurring business spend.",
      cadence: "daily",
    },
    {
      name: "Utilities & Bills",
      group: "Essential Expenses",
      note: "Power, internet, and communication tools.",
      cadence: "monthly",
    },
    {
      name: "Transport",
      group: "Essential Expenses",
      note: "Meetings, deliveries, and movement.",
      cadence: "daily",
    },
    {
      name: "Marketing",
      group: "Flexible Expenses",
      note: "Ads, content, promotions, and brand growth.",
      cadence: "weekly",
    },
    {
      name: "Lifestyle",
      group: "Flexible Expenses",
      note: "Personal enjoyment and flexible spending.",
      cadence: "weekly",
    },
    {
      name: "Tax Reserve",
      group: "Savings & Goals",
      note: "Set aside for levies, tax, and compliance.",
      cadence: "monthly",
    },
    {
      name: "Business Expansion",
      group: "Savings & Goals",
      note: "Reinvestment for growth opportunities.",
      cadence: "monthly",
    },
  ],
  freelancer: [
    {
      name: "Food & Utilities",
      group: "Essential Expenses",
      note: "Living costs and household spend.",
      cadence: "daily",
    },
    {
      name: "Housing",
      group: "Essential Expenses",
      note: "Rent and home essentials.",
      cadence: "monthly",
    },
    {
      name: "Internet & Tools",
      group: "Essential Expenses",
      note: "Software, data, subscriptions, and connectivity.",
      cadence: "monthly",
    },
    {
      name: "Transport",
      group: "Essential Expenses",
      note: "Client meetings and movement.",
      cadence: "daily",
    },
    {
      name: "Client Acquisition",
      group: "Flexible Expenses",
      note: "Portfolio, ads, networking, and proposals.",
      cadence: "weekly",
    },
    {
      name: "Lifestyle",
      group: "Flexible Expenses",
      note: "Entertainment and personal spending.",
      cadence: "weekly",
    },
    {
      name: "Tax Savings",
      group: "Savings & Goals",
      note: "A reserve for tax and compliance.",
      cadence: "monthly",
    },
    {
      name: "Device Upgrade Fund",
      group: "Savings & Goals",
      note: "Laptop, phone, and equipment replacement.",
      cadence: "monthly",
    },
  ],
};

const BUDGET_STYLE_SPLITS: Record<
  BudgetStyle,
...
const calculateInterestPreview = (categories: BudgetCategory[]) => {
  const eligibleCategories = categories.filter(
    (category) => daysBetweenTodayAnd(category.unlockDate) > 7,
  );
  const eligibleAmount = eligibleCategories.reduce(
    (sum, category) => sum + category.amount,
    0,
  );
  const annualRate =
    eligibleAmount <= 100000
      ? OPAY_ANNUAL_RATE_BELOW_100K
      : OPAY_ANNUAL_RATE_ABOVE_100K;
  ...
  const averageDays =
    eligibleAmount > 0
      ? weightedDays / Math.max(eligibleCategories.length, 1)
      : 0;
  const estimatedInterest =
    eligibleAmount * (annualRate / 100) * (averageDays / 365);
...
export default function BudgetSection({
  ...
  const [newCategoryGroup, setNewCategoryGroup] =
    useState<CategoryGroup>("Flexible Expenses");
  const [newCategoryCadence, setNewCategoryCadence] =
    useState<SpendingCadence>("weekly");
  ...
  const groupedCategories = useMemo(() => {
    ...
    return {
      "Essential Expenses": categories.filter(
        (item) => item.group === "Essential Expenses",
      ),
      "Flexible Expenses": categories.filter(
        (item) => item.group === "Flexible Expenses",
      ),
      "Savings & Goals": categories.filter(
        (item) => item.group === "Savings & Goals",
      ),
    };
  }, [budgetPlan]);
  ...
  const essentialsTotal =
    groupedCategories["Essential Expenses"]?.reduce(
      (sum, c) => sum + c.amount,
      0,
    ) || 0;
  const flexibleTotal =
    groupedCategories["Flexible Expenses"]?.reduce(
      (sum, c) => sum + c.amount,
      0,
    ) || 0;
  const goalsTotal =
    groupedCategories["Savings & Goals"]?.reduce(
      (sum, c) => sum + c.amount,
      0,
    ) || 0;
  ...
  const expensesData = [
    ...
    21000,
    32000,
    essentialsTotal + flexibleTotal + goalsTotal,
  ];
      ...
      <div className="mx-auto max-w-2xl space-y-6 py-4">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Plan, lock, and track your spending with discipline
          </p>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-1 text-sm text-slate-500">
              Pick your profession, budget style, and income to generate a full
              plan.
            </p>
          </button>
          ...
          >
            ...
            <p className="mt-1 text-sm text-slate-500">
              View your budget, edit allocations, and lock funds.
            </p>
            {budgetPlan && (
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">
              Set up your personalised spending plan in 3 steps
            </p>
          </div>
        </div>
        ...
        <section className="mx-auto max-w-4xl rounded-3xl bg-white p-8 shadow-xl md:p-10">
            ...
            <div>
              ...
              <h3 className="mt-2 text-2xl font-bold text-slate-900 md:text-3xl">
                {setupStep === "profession" &&
                  "1. Tell us what kind of earner you are"}
          ...
          {setupStep === "profession" && (
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {(Object.keys(PROFESSION_LABELS) as Profession[]).map(
                (option) => (
                  <button
                    key={option}
                  ...
                  >
                    ...
                    <p className="mt-2 text-sm text-slate-600">
                      {option === "student" &&
                        "Academic and low-to-mid income categories with education priorities."}
                      {option === "worker" &&
                        "Salary-driven monthly planning for fixed bills and long-term savings."}
                      {option === "entrepreneur" &&
                        "Personal plus business-related budgeting with cash-flow discipline."}
                      {option === "freelancer" &&
                        "Irregular-income planning with tools, client costs, and tax reserves."}
                    </p>
                  </button>
                ),
              )}
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">
              View and manage your spending allocations
            </p>
          </div>
        </div>
        <button
      ...
      {justCreated && (
        <div className="rounded-[20px] border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-800">
          Budget plan created successfully! Your spending categories have been
          generated.
        </div>
      )}
      ...
      {!budgetPlan ? (
        <div className="rounded-[24px] border border-dashed border-slate-300 bg-white p-12 text-center">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Create your first budget plan to start managing your spending.
          </p>
          <button
            onClick={() => {
              resetPlan();
          ...
          <section className="grid gap-4 md:grid-cols-4">
            <div className="rounded-[20px] border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-1 text-xl font-bold text-slate-900">
                {PROFESSION_LABELS[budgetPlan.profession]}
              </p>
            </div>
            <div className="rounded-[20px] border border-slate-200 bg-white p-5 shadow-sm">
              <p className="text-xs text-slate-500 uppercase tracking-wide">
            ...
            <div className="rounded-[20px] border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-1 text-xl font-bold text-slate-900">
                {formatCurrency(budgetPlan.income)}
              </p>
            </div>
            <div className="rounded-[20px] border border-slate-200 bg-white p-5 shadow-sm">
              <p className="text-xs text-slate-500 uppercase tracking-wide">
              ...
              <p
                className={`mt-1 text-xl font-bold ${remainingBalance < 0 ? "text-red-600" : "text-emerald-600"}`}
              >
            ...
            <div className="rounded-3xl bg-white p-8 shadow-xl">
              <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                <div>
                  ...
                  <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
                    Each category includes a total allocation, a daily expense
                    guide, a spending rhythm, and the exact date the money
                    should open for spending.
                  </p>
                </div>
              ...
              {!budgetPlan.lockedSummary && (
                <div className="mt-8 grid gap-8">
                  {(Object.keys(groupedCategories) as CategoryGroup[]).map(
                    (group) => (
                      <div
                        key={group}
                        className={`rounded-3xl border p-5 ${GROUP_COLORS[group]}`}
                      >
                        <div className="mb-4 flex items-center justify-between gap-4">
                          <div>
                            ...
                            <p className="text-sm text-slate-600">
                              {group === "Essential Expenses" &&
                                "Core daily and fixed bills that keep life running."}
                              {group === "Flexible Expenses" &&
                                "Lifestyle and adjustable expenses you can tune month to month."}
                              {group === "Savings & Goals" &&
                                "Future-focused money for security, growth, and planned targets."}
                            </p>
                          </div>
                          <div className="rounded-2xl bg-white px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm">
                            {formatCurrency(
                              groupedCategories[group].reduce(
                                (sum, item) => sum + item.amount,
                                0,
                              ),
                            )}
                        ...
                        <div className="space-y-4">
                          {groupedCategories[group].map((category) => (
                            <div
                              key={category.id}
                              className="rounded-2xl bg-white p-4 shadow-sm flex flex-col gap-2"
                            >
                              <div className="grid gap-4 xl:grid-cols-[1fr,0.8fr,0.8fr,0.9fr]">
                                ...
                                <div>
                                  ...
                                  />
                                  <p
                                    className={`mt-2 text-xs ${budgetMode === "strict" ? "text-cyan-700" : "text-red-500"}`}
                                  >
                                    {budgetMode === "strict"
                              ...
                              <div className="mt-4 grid gap-4 md:grid-cols-[0.8fr,1.2fr]">
                                  ...
                                  <select
                                    ...
                                    onChange={(event) =>
                                      updateCategory(
                                        category.id,
                                        "cadence",
                                        event.target.value as SpendingCadence,
                                      )
                                    }
                                    className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-sm text-slate-900 outline-none focus:border-cyan-500"
                                  >
                                ...
                                <div className="rounded-2xl bg-slate-50 p-4">
                                  ...
                                  <p className="mt-2 text-sm text-slate-700">
                                    {CADENCE_LABELS[category.cadence]} category
                                    with a suggested spend pace of{" "}
                                    <span className="font-semibold text-slate-900">
                                      {formatCurrency(category.dailyEstimate)}
                                    </span>{" "}
                                    per day.
                                  </p>
                                </div>
            ...
            <div className="space-y-6">
              {!budgetPlan.lockedSummary && (
                <section className="rounded-3xl bg-white p-8 shadow-xl">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    Add custom categories if your spending style needs something
                    extra beyond the generated list.
                  </p>
                  <div className="mt-6 grid gap-4">
                    ...
                    <select
                      ...
                      onChange={(event) =>
                        setNewCategoryGroup(event.target.value as CategoryGroup)
                      }
                      className="rounded-2xl border border-slate-300 px-4 py-3 text-sm text-slate-900 outline-none focus:border-cyan-500"
                    >
                      ...
                      <option value="Flexible Expenses">
                        Flexible Expenses
                      </option>
              ...
              {!budgetPlan.lockedSummary && (
                <section className="rounded-3xl bg-white p-8 shadow-xl">
                  ...
                  <p className="mt-2 text-sm text-slate-600">
                    Choose a start date, end date, and how often you want funds
                    released.
                  </p>
                  ...
                  {previewSchedule.length > 0 && (
                    <div className="mt-6">
                      ...
                      <p className="mt-1 text-xs text-slate-500">
                        {formatCurrency(totalAllocated)} split into{" "}
                        {previewSchedule.length} {lockFrequency} release
                        {previewSchedule.length > 1 ? "s" : ""}
                      </p>
                  ...
                  <div className="mt-6 space-y-3 text-sm text-slate-600">
                    <p>
                      ...
                      <span className="font-semibold text-slate-900">
                        {formatCurrency(planInterest.eligibleAmount)}
                      </span>
                    </p>
                    <p>
                      Estimated interest:{" "}
                      <span className="font-semibold text-emerald-700">
                        {formatCurrency(planInterest.estimatedInterest)}
                      </span>
                    </p>
                  </div>
                  ...
                  <button
                    onClick={lockFunds}
                    disabled={
                      remainingBalance < 0 || previewSchedule.length === 0
                    }
                  ...
                  {remainingBalance < 0 && (
                    <p className="mt-3 text-xs text-red-600">
                      Reduce allocations until your remaining balance becomes
                      zero or positive before locking funds.
                    </p>
                  )}
                </section>
              )}
                ...
                <section className="rounded-3xl border border-cyan-200 bg-cyan-50 p-8 shadow-xl">
                  <div className="text-center">
                    ...
                    <p className="mt-3 text-sm text-slate-500">
                      ...
                      locked since{" "}
                      {new Date(
                        budgetPlan.lockedSummary.lockedAt,
                    ...
                    <p className="mt-1 text-sm text-emerald-600 font-medium">
                      Estimated interest:{" "}
                      {formatCurrency(
                        budgetPlan.lockedSummary.eligibleInterest,
                      )}
                    </p>
                    <p className="mt-2 text-xs text-slate-500">
                      Releasing {budgetPlan.lockedSummary.unlockFrequency} from{" "}
                      {new Date(
                        budgetPlan.lockedSummary.startDate,
                      ).toLocaleDateString("en-NG", {
                        month: "short",
                        day: "numeric",
                      })}{" "}
                      to{" "}
                      {new Date(
                        budgetPlan.lockedSummary.endDate,
                      ).toLocaleDateString("en-NG", {
                        month: "short",
                        day: "numeric",
                        year: "numeric",
                      ...
                      <div className="mt-2 max-h-56 overflow-y-auto rounded-2xl border border-cyan-200 bg-white">
                        <table className="w-full text-sm">
                          <thead className="sticky top-0 bg-cyan-50">
                            <tr>
                              <th className="px-4 py-2 text-left text-xs font-semibold uppercase tracking-wider text-cyan-700">
                                Date
                              </th>
                              <th className="px-4 py-2 text-right text-xs font-semibold uppercase tracking-wider text-cyan-700">
                                Available
                              </th>
                            </tr>
                          </thead>
                          <tbody className="divide-y divide-cyan-100">
                            {budgetPlan.lockedSummary.schedule.map(
                              (entry, i) => {
                                const isPast =
                                ...
                                return (
                                  <tr
                                    key={i}
                                    className={isPast ? "bg-emerald-50" : ""}
                                  >
                                    <td className="px-4 py-2.5 text-slate-700">
                                      {new Date(entry.date).toLocaleDateString(
                                        "en-NG",
      ...
      {showPinModal && (
        <PinConfirmModal
          ...
          description={
            pinAction === "unlock"
              ? "Enter your PIN to unlock and release funds"
              : "Enter your PIN to secure your locked funds"
          }
          onConfirm={() => {

...
export default function KYCCompactTab({ session, onComplete }: { session: any, onComplete: () => void }) {
      ...
      {!showForm ? (
        <div className="bg-white rounded-2xl shadow-xl p-4 flex items-center gap-4 border border-[#E9EDF2]">
          <div className="flex-1">
            <div className="text-sm font-bold text-[#2c3e5f] mb-1">Complete your KYC</div>
            <div className="text-xs text-[#4A5B6E] mb-2">Verify your identity to unlock all features.</div>
            <button

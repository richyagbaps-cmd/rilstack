...
const SAVINGS_CATEGORIES = [
  {
    ...
    icon: "🛡️",
    description:
      "Emergency funds and financial cushion for unexpected expenses.",
    color: "text-blue-700",
    bgColor: "bg-blue-50",
  ...
  },
  {
    ...
    icon: "✈️",
    description:
      "Vacations, hobbies, and experiences you want to save towards.",
  ...
  },
  {
    ...
    label: "Housing",
    icon: "🏠",
    description: "Down payments, rent reserves, and home improvement funds.",
  ...
  },
  {
    ...
    label: "Education",
    icon: "📚",
    description: "Tuition, courses, certifications, and learning materials.",
  ...
  },
  {
    ...
    label: "Other",
    icon: "🎯",
    description: "Custom savings goals that don't fit the categories above.",
...
export default function SavingsGoals() {
  ...
  const categoryInfo = SAVINGS_CATEGORIES.find(
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-slate-500">
              Set targets, track progress, and save with purpose
            </p>
          </div>
        </div>
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-1 text-sm text-slate-500">
              Choose a category, set a target amount and deadline.
            </p>
          </button>
          <button
          ...
          >
            ...
            <p className="mt-1 text-sm text-slate-500">
              View progress, track balances, and manage your goals.
            </p>
            {goals.length > 0 && (
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-900">
              Choose a Savings Category
            </h2>
            <p className="text-sm text-slate-500">
              Select the type of goal you want to save for
            </p>
          </div>
        </div>
  ...
  if (view === "create" && selectedCategory && categoryInfo) {
    return (
      <div className="mx-auto max-w-lg space-y-6 py-4">
        ...
        <div
          className={`rounded-[24px] border ${categoryInfo.borderColor} ${categoryInfo.bgColor} p-5`}
        >
          <div className="flex items-center gap-3 mb-4">
            <span className="text-3xl">{categoryInfo.icon}</span>
            <div>
              <h3 className={`font-bold ${categoryInfo.color}`}>
                {categoryInfo.label}
              </h3>
    ...
    <div className="space-y-6 py-4">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-[20px] border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-2xl font-bold text-[#2c3e5f]">
            {overallProgress}%
          </p>
        </div>
      </div>
      ...
      {goals.length === 0 ? (
        ...
        <div className="space-y-4">
          {goals.map((goal) => {
            ...
            const catInfo = SAVINGS_CATEGORIES.find(
              ...
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <span
                          className={`rounded-full px-2 py-0.5 text-xs font-semibold ${catInfo ? `${catInfo.bgColor} ${catInfo.color}` : "bg-slate-100 text-slate-700"}`}
                        >
                ...
                <div className="mt-4">
                  ...
                  <div className="w-full bg-slate-100 rounded-full h-2.5">
                    <div
                      className="h-2.5 rounded-full bg-[#2c3e5f] transition-all"

...
export function suggestSavingsGoals(demographics: any): SavingsGoal[] {
  ...
  const goals: SavingsGoal[] = [
    { label: "Emergency Fund", description: "Save for unexpected expenses", icon: "🛡️" },
    { label: "Rent / House", description: "Save for rent or a new home", icon: "🏠" },
    { label: "Education", description: "Save for school or courses", icon: "🎓" },
    { label: "Travel", description: "Save for a trip or vacation", icon: "✈️" },
    { label: "Business", description: "Save to start or grow a business", icon: "💼" },
    { label: "Team Savings", description: "Save together with friends or family", icon: "🤝" },
  ];
